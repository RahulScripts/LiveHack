# Task-3-SmartContractIntegration-contracts
...
By default the template creates a single `HelloWorld` contract under task folder in the `smart_contracts` directory. To add a new contract:
